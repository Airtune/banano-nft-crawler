...
exports.assetMintCrawl = void 0;
function assetMintCrawl(_nanoNode, assetCrawler, _mintBlock) {
    return __awaiter(this, void 0, void 0, function () {
        var recipientAccount;
        return __generator(this, function (_a) {
            if (_mintBlock.subtype == 'send' && _mintBlock.type === 'state') {
                recipientAccount = _mintBlock.account;
                ...
                return [2 /*return*/, {
                        ...
                        message: "Unexpected mint block subtype: ".concat(_mintBlock.subtype, ". Expected 'send' or 'change'")
                    }];
            }
            return [2 /*return*/];
        });
...
exports.assetMintCrawl = assetMintCrawl;
