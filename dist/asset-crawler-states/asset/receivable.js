...
exports.receivableCrawl = void 0;
var find_receive_block_1 = require("../../lib/find-receive-block");
function receivableCrawl(nanoNode, assetCrawler) {
    return __awaiter(this, void 0, void 0, function () {
        var sendBlockHash, sender, recipient, receiveBlock, headBlock, receiveBlockSearchResult, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    receiveBlockSearchResult = _a.sent();
                    if (receiveBlockSearchResult.status === "ok") {
                        ...
                        return [2 /*return*/, receiveBlockSearchResult];
                    }
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
...
exports.receivableCrawl = receivableCrawl;
