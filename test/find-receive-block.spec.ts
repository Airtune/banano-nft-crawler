...
describe('findReceiveBlock', function() {
  ...
  it("can cache and resume detection of mint blocks", async () => {
    // Unopened account that didn't receive send.
    // It's a random account so it may be received in the future leaving this test obsolete.
    const {success, block } = await findReceiveBlock(bananode, "ban_3srq97fkug3nn1noiwaogufoyo457cgewpatxierjusrjrho87rgwept9y1u", "1851B63D6382722268FC3FCB6C99BC26E7A994ABE9CEC637F8E873CC36D3B1FB", "ban_3agsjomd4mo6amtsyizsbd8gkcgc7qkngmfpxk9iba9jjst7yomw9wu7bw51");
